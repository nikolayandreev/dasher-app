  ...
  <a
    ...
    :class="{
      'shadow-md bg-white scale-105':
        props.selectedSubscription === props.subscription,
      'bg-gray-200  scale-95':
        props.selectedSubscription !== props.subscription,
    }"
    @click.prevent="listeners.click"
  >
    <h4 class="block text-2xl font-medium text-center">
    ...
    <span class="block text-4xl font-normal font-display text-brand-500"
